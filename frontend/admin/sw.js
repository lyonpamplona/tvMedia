 ...
 *
 * Estrategia:
 *  - Estaticos do painel: network-first (pega novo deploy; cache offline).
 *  - Chamadas /api/ e /media/: network-first (dados sempre atuais).
 */

const CACHE = "tvmedia-studio-v27";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css",
...
self.addEventListener("fetch", (event) => {
  ...
  // App shell: REDE PRIMEIRO (pega novo deploy); cache como fallback offline.
  event.respondWith(
    fetch(req).then((res) => {
